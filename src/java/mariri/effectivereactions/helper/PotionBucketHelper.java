...
public class PotionBucketHelper {
	...
	public static Potion decodeEffect(int metadata){
		return Potion.getPotionById(metadata & EFFECT_MASK);
	}
	...
	public static int encodeMetadata(Potion effect, int amplifier, int duration, boolean splash){
		return encodeMetadata(effect, amplifier, duration, splash, 0);
	}

	public static int encodeMetadata(Potion effect, int amplifier, int duration, boolean splash, int higher){
		int meta = 0x00000000;
		meta |= Potion.getIdFromPotion(effect);
